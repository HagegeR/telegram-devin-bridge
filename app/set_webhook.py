...
async def main() -> None:
    ...
    try:
        ...
        try:
            await client.set_my_commands(full_commands)
            ...
            await client.set_my_description(DESCRIPTION)
            await client.set_my_short_description("Two-way bridge to Devin sessions")
